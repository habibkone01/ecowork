                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="bg-white rounded-2xl p-6 border border-gray-100 mb-6 flex items-center gap-6">
                        <div className="w-20 h-20 rounded-2xl flex items-center justify-center shrink-0"
                            ...
                            <User size={32} className="text-[#1a1a2e]" />
                        </div>
                        <div>
                            <h2 className="text-xl font-bold text-[#1a1a2e]">{user?.prenom} {user?.nom}</h2>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="password" name="password" value={form.password} onChange={handleChange}
                                            placeholder="••••••••"
                                            className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:border-[#7bdff2] focus:ring-2 focus:ring-[#7bdff226]" />
                                    </div>
                                </div>
                                <div>
