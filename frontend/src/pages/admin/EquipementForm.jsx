            ...
            <main className="ml-65 flex-1 min-h-screen bg-gray-50 p-8">
                <div className="max-w-lg mx-auto">
                    ...
                    <div className="flex items-center gap-3 mb-8">
                        <Link to="/admin/equipements" className="p-2 rounded-xl border border-gray-200 text-gray-500 hover:bg-gray-50 no-underline">
                            <ArrowLeft size={18} />
                        </Link>
                        <div>
                            <h1 className="text-2xl font-bold text-[#1a1a2e]">{isEdit ? 'Modifier' : 'Ajouter'} un équipement</h1>
